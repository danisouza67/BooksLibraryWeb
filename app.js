...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('BooksLibrary.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('BooksLibrary.xsl', 'utf8'); //We are reading in the XSL file
